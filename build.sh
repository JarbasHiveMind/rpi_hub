...
uv pip install --pre ovos-google-translate-plugin ovos-tts-plugin-piper ovos-stt-plugin-fasterwhisper ovos-solver-openai-persona-plugin
...
ln -s /home/$USER/.config/systemd/user/ovos-persona.service /home/$USER/.config/systemd/user/default.target.wants/ovos-persona.service
